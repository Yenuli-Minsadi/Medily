...
type PrescriptionStatus = "pending" | "accepted" | "dispensed" | "rejected";
...
interface Prescription {
  ...
  medications: { name: string; dosage: string; qty: number; days: number }[];
  notes?: string;
  urgent: boolean;
  distance?: string;
}
...
const PRESCRIPTIONS: Prescription[] = [
  {
    ...
    distance: "0.3 km",
    medications: [
      { name: "Atorvastatin", dosage: "20mg", qty: 30, days: 30 },
      { name: "Metoprolol", dosage: "50mg", qty: 60, days: 30 },
    ],
  ...
  },
  {
    ...
    distance: "0.8 km",
    medications: [
      { name: "Amoxicillin", dosage: "500mg", qty: 21, days: 7 },
      { name: "Ibuprofen", dosage: "400mg", qty: 15, days: 5 },
    ],
  },
  {
    id: "RX-2024-003",
    ...
    urgent: false,
    medications: [
      { name: "Metformin", dosage: "1000mg", qty: 60, days: 30 },
      { name: "Sitagliptin", dosage: "100mg", qty: 30, days: 30 },
      { name: "Lisinopril", dosage: "10mg", qty: 30, days: 30 },
    ],
  },
  {
    id: "RX-2024-004",
    ...
    status: "dispensed",
    urgent: false,
    medications: [{ name: "Sertraline", dosage: "50mg", qty: 30, days: 30 }],
  ...
  },
  {
    ...
    distance: "1.2 km",
    medications: [
      { name: "Methotrexate", dosage: "15mg", qty: 4, days: 28 },
      { name: "Folic Acid", dosage: "5mg", qty: 6, days: 7 },
    ],
    notes: "Weekly dosing — counsel patient carefully.",
  },
];

const NEARBY_PATIENTS: NearbyPatient[] = [
  {
    id: "NP-001",
    name: "James Okafor",
    avatar:
...
const PharmacistDashboard: React.FC = () => {
  ...
  const menuItems: {
    ...
    },
    {
      ...
      label: "Inventory",
      icon: <Icon.Package />,
      badge: INVENTORY.filter((i) => i.stock <= i.threshold).length,
    },
    { id: "patients", label: "Patients", icon: <Icon.Users /> },
    { id: "orders", label: "Orders", icon: <Icon.ShoppingCart /> },
