    ...
    switch (name) {
      case "email":
        return !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value as string)
          ...
          : "";
      case "phone":
        return !/^\+?[\d\s\-()]+$/.test(value as string)
  ...
  const stepHeaders = [
    {
      ...
      sub: "Choose your role so we can tailor your experience from day one",
    },
    {
      title: "Tell us about yourself",
      sub: "Your details help us personalise your healthcare profile",
    },
    {
      title: "Secure your account",
      sub: "Set up a strong password to protect your medical data",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute w-[600px] h-[600px] rounded-full opacity-25 -top-[200px] -right-[200px]"
          style={{
            filter: "blur(80px)",
            background: "radial-gradient(circle, #c5a3e0 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute w-[500px] h-[500px] rounded-full opacity-25 -bottom-[150px] -left-[150px]"
          style={{
            filter: "blur(80px)",
            background: "radial-gradient(circle, #7bc5d3 0%, transparent 70%)",
          }}
        />
      </div>
        ...
        >
          ...
          <div className="mb-8 flex items-center gap-3">
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #7bc5d3, #c5a3e0)",
              }}
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                ...
                <defs>
                  ...
                  <linearGradient id="g2" x1="2" y1="17" x2="22" y2="22">
                    <stop offset="0%" stopColor="#B8E0E8" />
            ...
            <div className="flex gap-1 mb-3.5">
              {[1, 2, 3].map((step) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-[30px] h-[30px] flex-shrink-0 rounded-full flex items-center justify-center font-bold text-[13px]"
                      style={{
                        background: isDone
                          ? "linear-gradient(135deg,#10b981,#059669)"
                          : isActive
                            ? "linear-gradient(135deg,#7bc5d3,#c5a3e0)"
                            : "#e5e7eb",
                    ...
                    <span
                      className={`text-[11px] whitespace-nowrap ${isActive ? "font-bold text-[#1a1a1a]" : "font-medium text-[#9ca3af]"}`}
                    >
                      {stepLabels[step - 1]}
                    </span>
                  </div>
          ...
          <div className="mb-7">
            <div className="flex justify-center mb-4">
              <div
                className="inline-flex items-center gap-1.5 px-4 py-[7px] rounded-3xl text-xs font-semibold"
                style={{
                  background: "linear-gradient(90deg,#e8d5f2,#b8e0e8)",
                  color: "#0f1c2e",
                }}
              >
            ...
            <h1
              className="text-[26px] font-bold leading-tight mb-1.5"
              style={{ color: "#1a1a1a" }}
            >
            ...
            <AnimatePresence mode="wait">
              ...
              {currentStep === 1 && (
                ...
                >
                        ...
                        <div
                          ...
                          style={{
                            ...
                            background: isSelected
                              ? "linear-gradient(135deg, rgba(123,197,211,0.08), rgba(197,163,224,0.08))"
                              : "white",
                            boxShadow: isSelected
                              ? "0 4px 20px rgba(123,197,211,0.16)"
                              : "none",
                          }}
                        >
                          <div
                            ...
                            style={{
                              background: isSelected
                                ? "linear-gradient(135deg,#7bc5d3,#c5a3e0)"
                                : "linear-gradient(135deg,#f0f9fb,#f5effe)",
                            }}
                          >
                            <RoleIcon
                              value={role.value}
                  ...
                  {errors.userType && (
                    <span className="block text-red-500 text-xs mt-1.5 font-medium">
                      {errors.userType}
                    </span>
                  )}
                  ...
                  <div className="flex justify-center mt-7">
                    <motion.button
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #0f1c2e 0%, #1a2942 100%)",
                      }}
              ...
              {currentStep === 2 && (
                ...
                >
                  <div
                    className="flex items-center gap-2 rounded-xl px-4 py-2.5 mb-5 text-[13px]"
                    style={{
                      background: "rgba(123,197,211,0.08)",
                      border: "1px solid rgba(123,197,211,0.25)",
                    }}
                  >
                    ...
                    <button
                      ...
                      className="bg-transparent border-none cursor-pointer text-[13px] font-semibold p-0"
                      style={{ color: "#7bc5d3" }}
                    >
                      Change
                    </button>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="mb-4">
                      <label
                        className="block text-[13px] font-semibold mb-[7px]"
                        style={{ color: "#1a1a1a" }}
                      >
              ...
              {currentStep === 3 && (
                ...
                >
                  ...
                  {errors.terms && (
                    <span className="block text-red-500 text-xs mb-4 font-medium">
                      {errors.terms}
                    </span>
                  )}
              ...
              {[
                ...
                >
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg,#b8e0e8,#e8d5f2)",
                      color: "#0f1c2e",
                    }}
                  >
                    {b.icon}
